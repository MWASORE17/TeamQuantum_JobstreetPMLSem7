...
public class loker4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loker4);
            ...
            public void onClick(View view){
                ...
                })
                {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        parameters.put("firstname","PT. Grafika");
                        parameters.put("lastname","Graphic Design");
