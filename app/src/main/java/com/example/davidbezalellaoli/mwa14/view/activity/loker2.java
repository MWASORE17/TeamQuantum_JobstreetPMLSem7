...
public class loker2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loker2);
            ...
            public void onClick(View view){
                ...
                })
                {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        parameters.put("firstname","Medan Musik");
                        parameters.put("lastname","Accounting");
